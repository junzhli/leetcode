...
public class Solution {
    ...
    // use recursion
    // divide given string into part by the char which is not acquired for being included in the substring
    // return the max number of length of substring that is acquired
